...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220331_boutique_wine_bddf454a27543a768536_20220331125501_archive.zip';
	const ARCHIVE_SIZE		 = '208559783';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bddf454-31125501';
    const SECONDARY_PACKAGE_HASH = '19d9f45-31125501';
	const VERSION			 = '1.4.4';
